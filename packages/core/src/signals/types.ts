...
export type SignalSetter<TValue, TOwner = void> = (
  value: SignalValue<TValue> | typeof DEFAULT,
) => TOwner;

export type SignalGetter<TValue> = () => TValue;

export type SignalTween<TSetterValue, TValue extends TSetterValue> = (
